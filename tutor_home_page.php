<?php
    ...
    if(isset($_GET['filter'])){
        $array = [$_POST['badge'], $_POST['date'], $_POST['time']];
                ...
                <section class=''>
                    <div class='content-box position-content'>
                        <div class='input-container position-filter'>
                            <form action="tutor_home_page.php?filter" method="POST">
                                <select name="filter">
                                    ...
                                    ?>
                                    <option value=""><?php echo $badge['nome']?></option>
                                    <?php } ?>
                                </select>
                                    ...
                                    <input type="hidden" name='badge' value='<?php echo $badge['cod_distintivo']?>'>
