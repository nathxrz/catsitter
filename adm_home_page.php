    ...
    <section class='padding-form'>
            <div class="content-box position-content">
                ...
                <?php }else{ 
                    ...
                    <div class='content-box info-container-profile badges-width'>
                        ...
                        <a href="adm_home_page.php?delete=<?php echo ($badge['cod_distintivo'])?>" class='close close-form reset-btn-decoration icon-trash'>
        ...
        <section id="form-adm-add-badges" class="position-forms modal hidden">
            <div class="content-box">
                <button id="btn-close-adm-add-badges" class='close close-form reset-btn-decoration'>
                    ...
                    <?php } else {
                        ...
                        <div class="card-profile">
                            <a href="view_<?php if(checksIfTheUserIsASitter($user['cod_usuario'], $pdo)){ echo ('sitter'); } else { echo ('tutor');} ?>_page.php?user=<?php echo $user['cod_usuario']?>">
                                <img class="img-profile" src="images/<?php echo $user['foto']?>" alt="Foto do usuário">
                            </a>
                            <p title="<?php echo $user['nome'] . " ". $user['sobrenome']?>"><?php echo $user['nome'] . " ". $user['sobrenome']?></p>
