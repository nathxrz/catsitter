            ...
            <div class="content-box position-content-schedule">
                ...
                <?php } else { 
                        foreach($schedules as $schedule) { 
                            $tutor = searchTutor($schedule['cod_usuario'], $pdo);
                        ?>
                <div class="card-schedule">
                    ...
                    <div class='appointment-information'>
                        ...
                        <div>
                            <p>Endereço: </p>
                            <span><?php echo $tutor['rua'] . ", " . $tutor['numero'] . ". " .  $tutor['cidade'] ?></span>
                        </div>
                        <div>
                        <?php 
                    ...
                    <div class='icons-shedule'>
                        ...
                        <a href="sitter_schedule_page.php?delete=<?php echo ($schedule['cod_agendamento'])?>" class='reset-btn-decoration'>
